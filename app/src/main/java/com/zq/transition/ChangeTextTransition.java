...
public class ChangeTextTransition extends Transition {
    private static final String PROPNAME_TEXT = "ysh:changeText:text";
    private static final String PROPNAME_TEXT_COLOR = "ysh:changeTextColor:color";
    private static final String PROPNAME_TEXT_SIZE = "ysh:changeTextSize:size";
    private static final String PROPNAME_TEXT_LEVEL = "ysh:changeTextTypeface:level";
