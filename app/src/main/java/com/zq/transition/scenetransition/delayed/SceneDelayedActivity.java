package com.zq.transition.scenetransition.delayed;
...
public class SceneDelayedActivity extends AppCompatActivity {
    ...
    private void toggleScene() {
        ...
        transitionSet.addTransition(new ChangeTransform()).addTransition(new ChangeBounds());
        TransitionManager.beginDelayedTransition(mViewSceneRoot, transitionSet);
        /**
         * 四个角的View相互交换位置
         */
        if (mStartScene) {
